...
const mockStudents = [
  { id: 1, name: "Ali Ahmed", rollNo: "C1-001", feeStatus: "Paid" },
  { id: 2, name: "Sara Raza", rollNo: "C1-002", feeStatus: "Pending" },
  { id: 3, name: "Zainab Bibi", rollNo: "C1-003", feeStatus: "Overdue" },
  { id: 4, name: "Hassan Ali", rollNo: "C1-004", feeStatus: "Paid" },
  { id: 5, name: "Ayesha Khan", rollNo: "C1-005", feeStatus: "Paid" },
]
